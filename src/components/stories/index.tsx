...
const Stories: React.FunctionComponent<IStoriesProps> = (props) => {
    return <div className='flex justify-between '>
        ...
        <img src={image2} alt="stories image"
            className='w-20 h-20 rounded-full border-4 border-slate-800 object-cover' />
        <img src={image3} alt="stories image"
            className='w-20 h-20 rounded-full border-4 border-slate-800 object-cover' />
        <img src={image4} alt="stories image"
            className='w-20 h-20 rounded-full border-4 border-slate-800 object-cover' />
        <img src={image5} alt="stories image"
            className='w-20 h-20 rounded-full border-4 border-slate-800 object-cover' />
        <img src={image6} alt="stories image"
            className='w-20 h-20 rounded-full border-4 border-slate-800 object-cover' />
